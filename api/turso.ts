...
const mapRowToJSON = (collection: string, row: any) => {
  switch (collection) {
    case 'eduadmin_users': return {
        ...
        extracurriculars: Boolean(row.is_extracurricular_advisor) ? parseJSONSafe(row.extracurriculars) : [],
    ...
    if (action === 'login') {
        ...
        try {
            ...
            const user = {
                ...
                extracurriculars: Boolean(userRow.is_extracurricular_advisor) ? parseJSONSafe(userRow.extracurriculars) : [],
