                    ...
                    <table className="w-full text-xs border-collapse min-w-max">
                        <thead>
                            <tr className="bg-gray-100 text-gray-700">
                                ...
                                <th className="p-3 border-r border-b border-gray-200 min-w-[150px] text-left sticky left-10 top-0 bg-gray-100 z-30 shadow-[2px_2px_5px_rgba(0,0,0,0.05)]">Nama Siswa</th>
                                {days.map(d => {
                            ...
                            {students.map((student, idx) => {
                                ...
                                return (
                                    <tr key={student.id} className="hover:bg-gray-50 transition-colors group">
                                        <td className="p-3 text-center border-r border-gray-100 sticky left-0 bg-white group-hover:bg-gray-50 z-10 shadow-[2px_0_5px_rgba(0,0,0,0.02)]">{idx + 1}</td>
                                        <td className="p-3 border-r border-gray-100 font-medium text-gray-800 sticky left-10 bg-white group-hover:bg-gray-50 z-10 truncate max-w-[150px] shadow-[2px_0_5px_rgba(0,0,0,0.02)]">{student.name}</td>
                                        {days.map(d => {
                                            const event = getEventForDay(d);
                                            const isHoliday = (event && (event.type === 'HOLIDAY' || event.type === 'LEAVE')) || isWeekend(d);
                                            ...
                                            return (
                                                <td key={d} className="relative group/cell">
                                                    <div 
